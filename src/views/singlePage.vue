<template>
  ...
  <div v-if="product" class="container">
    ...
    <div class="tabs">
      <ul>
        <li><a href="#tab1"><span></span></a></li>
        <li><a href="#tab2"><span></span></a></li>
        <li><a href="#tab3"><span></span></a></li>
      </ul>
      <div id="tab1">
        <p>
        ...
        <div class="priceContainer">
          <div>
            ...
            <svg id="ratingsSVG" viewBox="0 0 250 45.59">
                            <polygon class="starFull" points="23.97 0 31.37 15.01 47.93 17.41 35.95 29.09 38.78 45.59 23.97 37.8 9.15 45.59 11.98 29.09 0 17.41 16.56 15.01 23.97 0"/>
                            <polygon class="starFull" points="74.48 0 81.89 15.01 98.45 17.41 86.47 29.09 89.3 45.59 74.48 37.8 59.67 45.59 62.5 29.09 50.52 17.41 67.08 15.01 74.48 0"/>
                            <polygon class="starFull" points="125 0 132.41 15.01 148.97 17.41 136.98 29.09 139.81 45.59 125 37.8 110.19 45.59 113.02 29.09 101.03 17.41 117.59 15.01 125 0"/>
                            <polygon class="starFull" points="175.52 0 182.92 15.01 199.48 17.41 187.5 29.09 190.33 45.59 175.52 37.8 160.7 45.59 163.53 29.09 151.55 17.41 168.11 15.01 175.52 0"/>
                            <polygon class="starEmpty" points="226.03 0 233.44 15.01 250 17.41 238.02 29.09 240.84 45.59 226.03 37.8 211.22 45.59 214.05 29.09 202.07 17.41 218.63 15.01 226.03 0"/>
                        </svg>
          </div>
          <p class="price"><span>$1,000,000</span>${{product.price}}</p>
        </div>
      </div>
      <div id="tab2">
        <p>10 outta 10</p>
    ...
    <!-- .tabs -->
    <div class="cart">
     <router-link to="/products"><button  class="return">Continue Shopping</button></router-link> 
      <div>
        ...
        <button  @click="this.$store.dispatch('addToCart',product )"  class="confirm"><i class="fa-solid fa-cart-shopping"></i>Add to Cart</button>
      </div>
    </div>
  </div>
  <!-- .right -->
...
<div v-else>
  ...
  <!-- <div class="wall">
    ...
    <div v-if="product" class="wrapper vh-100">
